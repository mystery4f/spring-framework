...
public class EnvironmentPropertySourceChangeDemo {
	...
	public static void main(String[] args) {
		...
		EnvironmentPropertySourceChangeDemo environmentPropertySourceChangeDemo = context.getBean(
				EnvironmentPropertySourceChangeDemo.class);
